...
role and the error queue policy are least-privilege. I've made GitHub releases
immutable as of `v2.4.0`&nbsp;.
...
- development/test databases not needed every week
- developer vacations or leaves of absence beyond one week
...
AWS account. To deploy in multiple regions and/or multiple AWS accounts,
 ...
 3. Install Step-Stay-Stopped as a CloudFormation StackSet, using
    ...
    - **CloudFormation**<br/>_Easy_ &check;
      ...
      [Create a CloudFormation StackSet](/../../blob/v2.4.0/cloudformation/step_stay_stopped_aws_rds_aurora.yaml?raw=true).
