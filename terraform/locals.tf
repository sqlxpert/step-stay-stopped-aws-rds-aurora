  ...
  step_stay_stopped_tags = merge(
    {
      ...
      source = "https://github.com/sqlxpert/step-stay-stopped-aws-rds-aurora/blob/main/terraform"
    },
    var.step_stay_stopped_tags,
  )
}
